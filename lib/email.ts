...
export async function sendUpgradeConfirmation(
  ...
  try {
    ...
    const planName = options?.planName || "Pro";
    const appUrl = process.env.NEXT_PUBLIC_APP_URL || "https://betterdeals.vercel.app";
    const cleanAppUrl = appUrl.replace(/\/$/, "");
    const dashboardUrl = `${cleanAppUrl}/dashboard`;

    const subject = `Welcome to Better Deals ${planName} \u2014 You're all set!`;

    const plainText = [
      `Welcome to Better Deals ${planName}!`,
      "",
      ...
      "- Priority support",
      "",
      `Start tracking: ${dashboardUrl}`,
      "",
      "Thank you for choosing Better Deals.",
    ].join("\n");
        ...
        <table role="presentation" width="620" cellpadding="0" cellspacing="0" style="max-width:620px;width:100%;border-radius:20px;overflow:hidden;background:#ffffff;box-shadow:0 10px 30px rgba(15,23,42,0.08);">
          ...
          <tr>
            <td style="padding:28px 28px 0 28px;text-align:center;">
              <div style="display:inline-block;padding:6px 14px;border-radius:999px;background:#dcfce7;color:#166534;font-size:12px;font-weight:700;letter-spacing:0.3px;">
                UPGRADE CONFIRMED
              </div>
              <h1 style="margin:16px 0 8px 0;font-size:26px;line-height:1.3;color:#0f172a;">
                Welcome to ${escapeHtml(planName)}!
              </h1>
              <p style="margin:0;font-size:15px;line-height:1.6;color:#475569;">
                Your upgrade has been processed successfully. You now have full access to all premium features.
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:22px 28px 0 28px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border-radius:14px;background:#f8fafc;overflow:hidden;">
                <tr>
                  <td style="padding:20px 22px;">
                    <div style="font-size:14px;font-weight:700;color:#0f172a;margin-bottom:14px;">What&rsquo;s included in your plan</div>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td style="padding:6px 0;font-size:14px;color:#334155;">&#10003;&nbsp;&nbsp;Unlimited product tracking</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:14px;color:#334155;">&#10003;&nbsp;&nbsp;Real-time price drop alerts</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:14px;color:#334155;">&#10003;&nbsp;&nbsp;Full price history &amp; analytics</td>
                      </tr>
                      <tr>
                        <td style="padding:6px 0;font-size:14px;color:#334155;">&#10003;&nbsp;&nbsp;Priority support</td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td style="padding:22px 28px 0 28px;text-align:center;">
              <a href="${escapeHtml(dashboardUrl)}" target="_blank" rel="noopener noreferrer"
                 style="display:inline-block;background:linear-gradient(180deg,#7dd3fc 0%,#3b82f6 100%);color:#ffffff;padding:14px 32px;text-decoration:none;border-radius:12px;font-weight:700;font-size:15px;box-shadow:0 4px 14px rgba(56,189,248,0.4);">
                Start Tracking
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:26px 28px 28px 28px;text-align:center;">
              <p style="margin:0;font-size:13px;color:#94a3b8;line-height:1.6;">
                Thank you for choosing Better Deals.<br />
                <a href="${escapeHtml(dashboardUrl)}" style="color:#64748b;text-decoration:underline;">Go to dashboard</a>
              </p>
            </td>
          </tr>
        </table>
